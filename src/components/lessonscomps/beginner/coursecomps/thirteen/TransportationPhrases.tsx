      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-3">
          ...
          <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
            <p className="font-medium text-yellow-800">Bghīt nimshī l...</p>
            <p className="text-gray-700">I want to go to...</p>
          </div>
          <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
            <p className="font-medium text-yellow-800">Bshḥāl?</p>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-blue-50 p-3 rounded border border-blue-200">
            <p className="font-medium text-blue-800">Fīn maḥaṭṭat al-ṭūbīs?</p>
            <p className="text-gray-700">Where is the bus station?</p>
          </div>
          <div className="bg-blue-50 p-3 rounded border border-blue-200">
            <p className="font-medium text-blue-800">Ayy ṭūbīs l...?</p>
