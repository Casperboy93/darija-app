    ...
    <div className="mb-10">
      ...
      <div className="space-y-4">
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-gray-700">ʿĪd mubārak</span>
              <span className="text-gray-600 text-sm">Blessed Eid</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-700">Kull ʿām u ntūma b khayr</span>
              <span className="text-gray-600 text-sm">May you be well every year</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-700">ʿĪd saʿīd</span>
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-gray-700">Ramaḍān mubārak</span>
              <span className="text-gray-600 text-sm">Blessed Ramadan</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-700">Ramaḍān karīm</span>
              <span className="text-gray-600 text-sm">Generous Ramadan</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-700">Allāh yataqabbal minnā</span>
