      ...
      <div className="space-y-6">
        <div className="border border-purple-200 rounded-lg p-5 bg-white">
          ...
          <div className="bg-blue-50 p-4 rounded-md">
            ...
            <p className="text-gray-700 mb-3">واش كاتعتقد أن الحرية مطلقة ولا نسبية؟</p>
            ...
            <p className="text-gray-700 mb-2">من وجهة نظري، الحرية نسبية. لأن حريتك تنتهي عندما تبدأ حرية الآخرين. هذا المفهوم معقد ويحتاج تحليل عميق.</p>
        ...
        <div className="border border-purple-200 rounded-lg p-5 bg-white">
          ...
          <div className="bg-green-50 p-4 rounded-md">
            ...
            <p className="text-gray-700 mb-3">النتائج ديال البحث كتبين أن هناك علاقة قوية بين المتغيرين</p>
            ...
            <p className="text-gray-700 mb-2">ولكن واش العينة كافية؟ من المهم أن نأخذ بعين الاعتبار العوامل الخارجية التي قد تؤثر على النتائج.</p>
