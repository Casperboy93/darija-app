  ...
  return (
    <div className="bg-purple-50 border border-purple-200 p-6 rounded-lg mb-8">
      ...
      <p className="text-gray-700">
        Master the cultural nuances that shape Darija expressions and learn to navigate social situations 
        with appropriate language and cultural awareness. Understanding these contexts is crucial for 
        meaningful communication in Moroccan society.
      </p>
