  ...
  return (
    <div className="bg-indigo-50 border border-indigo-200 p-6 rounded-lg mb-8">
      ...
      <p className="text-gray-700">
        Explore the rich literary and poetic traditions of Moroccan Arabic. Learn to appreciate, understand, 
        and create beautiful expressions using classical and modern literary techniques.
      </p>
