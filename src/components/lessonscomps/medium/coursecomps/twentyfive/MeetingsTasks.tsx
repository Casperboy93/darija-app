      ...
      <table className="min-w-full table-auto border border-gray-200">
        ...
        <tbody className="text-gray-700">
          <tr className="border-t">
            ...
            <td className="px-4 py-2">نبدأو الاجتماع</td>
          ...
          <tr className="border-t">
            ...
            <td className="px-4 py-2">شنو الأولويات ديال اليوم؟</td>
          ...
          <tr className="border-t">
            ...
            <td className="px-4 py-2">الحد الأقصى نهار الجمعة</td>
          ...
          <tr className="border-t">
            ...
            <td className="px-4 py-2">نراجعو الأسبوع الجاي</td>
