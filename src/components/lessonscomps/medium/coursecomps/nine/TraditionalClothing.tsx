        ...
        <div className="bg-indigo-50 border border-indigo-200 p-5 rounded-lg">
          ...
          <div className="space-y-3">
            <div className="bg-white p-3 rounded-md border-l-4 border-indigo-400">
              <p className="text-sm"><span className="font-semibold">Jallaba:</span> Traditional robe</p>
              <p className="text-xs text-gray-500">Long, loose-fitting hooded robe</p>
            </div>
            <div className="bg-white p-3 rounded-md border-l-4 border-indigo-400">
              <p className="text-sm"><span className="font-semibold">Tarbush:</span> Traditional hat (fez)</p>
              <p className="text-xs text-gray-500">Red felt hat with tassel</p>
            </div>
            <div className="bg-white p-3 rounded-md border-l-4 border-indigo-400">
              <p className="text-sm"><span className="font-semibold">Sarwal:</span> Traditional pants</p>
        ...
        <div className="bg-indigo-50 border border-indigo-200 p-5 rounded-lg">
          ...
          <div className="space-y-3">
            <div className="bg-white p-3 rounded-md border-l-4 border-pink-400">
              <p className="text-sm"><span className="font-semibold">Qaftan:</span> Traditional dress</p>
              <p className="text-xs text-gray-500">Long, flowing dress with wide sleeves</p>
            </div>
            <div className="bg-white p-3 rounded-md border-l-4 border-pink-400">
              <p className="text-sm"><span className="font-semibold">Takshita:</span> Formal traditional dress</p>
              <p className="text-xs text-gray-500">Elaborate dress for special occasions</p>
            </div>
            <div className="bg-white p-3 rounded-md border-l-4 border-pink-400">
              <p className="text-sm"><span className="font-semibold">Haik:</span> Traditional white wrap</p>
