      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        <div className="border border-purple-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "3id l Fitr 3id kbir f l Maghrib" (Eid al-Fitr is a big celebration in Morocco)</p>
          </div>
        </div>
        ...
        <div className="border border-purple-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "F 3id l Adha kandhbahu l kharuf" (On Eid al-Adha we sacrifice the sheep)</p>
          </div>
        </div>
        ...
        <div className="border border-purple-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "F Mawlid kanqraw l Qur'an" (On Mawlid we recite the Quran)</p>
          </div>
        </div>

        <div className="border border-purple-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between">
            <p className="font-bold text-lg text-gray-900">Ashura</p>
            <span className="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Festival</span>
          </div>
          <p className="text-gray-600">Day of Ashura</p>
          <p className="text-sm italic mt-2 text-gray-500">Pronounced: a-shu-ra</p>
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "F Ashura l atfal kayaklu l halwa" (On Ashura children eat sweets)</p>
          </div>
        </div>
      </div>
    </div>
