        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-md border-l-4 border-yellow-400">
            ...
            <div className="space-y-1 text-sm">
              <p><span className="font-semibold">Salat:</span> Prayer</p>
              <p><span className="font-semibold">Masjid:</span> Mosque</p>
              <p><span className="font-semibold">Wudu':</span> Ablution</p>
          ...
          <div className="bg-white p-4 rounded-md border-l-4 border-yellow-400">
            ...
            <div className="space-y-1 text-sm">
              <p><span className="font-semibold">Ramadan:</span> Holy month of fasting</p>
              <p><span className="font-semibold">Siyam:</span> Fasting</p>
              <p><span className="font-semibold">Iftar:</span> Breaking fast</p>
              <p><span className="font-semibold">Suhur:</span> Pre-dawn meal</p>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-md border-l-4 border-yellow-400">
            ...
            <div className="space-y-1 text-sm">
              <p><span className="font-semibold">Hajj:</span> Pilgrimage to Mecca</p>
              <p><span className="font-semibold">3umra:</span> Lesser pilgrimage</p>
              <p><span className="font-semibold">Hajj:</span> One who completed Hajj</p>
              <p><span className="font-semibold">Ziyara:</span> Religious visit</p>
            </div>
          </div>
        </div>
      </div>
