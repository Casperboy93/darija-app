      ...
      <div className="bg-pink-50 p-6 rounded-lg border border-pink-200">
        ...
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg border-l-4 border-pink-400">
            ...
            <p className="text-gray-700">Kayf tara al-ʿalaqa bayn at-turath wa al-hadatha fi al-Maghrib?</p>
          ...
          <div className="bg-white p-4 rounded-lg border-l-4 border-blue-400">
            ...
            <p className="text-gray-700">Hadhihi zahira thaqafiyya muʿaqqada. Al-Maghrib yanjah fi al-muhafaza ʿala hawiyyatihi maʿa al-tanmiya.</p>
          ...
          <div className="bg-white p-4 rounded-lg border-l-4 border-pink-400">
            <p className="font-medium text-gray-800">Cultural Scholar A:</p>
            <p className="text-gray-700">Naʿam, wa hadha yazhar fi al-miʿmar wa al-funun at-taqlidiyya allati ma zalat hayya.</p>
            <p className="text-sm text-gray-600 mt-1">Yes, and this appears in architecture and traditional arts that remain alive.</p>
          </div>
          
          <div className="bg-white p-4 rounded-lg border-l-4 border-blue-400">
            <p className="font-medium text-gray-800">Cultural Scholar B:</p>
            <p className="text-gray-700">Bi-l-fiʿl, al-hirfiyyun al-Maghariba yahmilun amana thaqafiyya ʿazima.</p>
