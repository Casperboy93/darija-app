      ...
      <div className="bg-pink-50 p-6 rounded-lg border border-pink-200">
        ...
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg border-l-4 border-pink-400">
            ...
            <p className="text-gray-700">Ma raʾyuk fi mashruʿ Noor Ouarzazate li-t-taqa ash-shamsiyya?</p>
          ...
          <div className="bg-white p-4 rounded-lg border-l-4 border-blue-400">
            ...
            <p className="text-gray-700">Aʿtaqid annahu mashruʿ mumtaz li-muharaba taghyir al-munakh.</p>
            <p className="text-sm text-gray-600 mt-1">I think it's an excellent project to combat climate change.</p>
          </div>
          
          <div className="bg-white p-4 rounded-lg border-l-4 border-pink-400">
            <p className="font-medium text-gray-800">Environmentalist:</p>
            <p className="text-gray-700">Naʿam, wa yajib ʿalayna aydan an nuqallil min istihlak al-miyah.</p>
            <p className="text-sm text-gray-600 mt-1">Yes, and we should also reduce our water consumption.</p>
          </div>
          
          <div className="bg-white p-4 rounded-lg border-l-4 border-blue-400">
            <p className="font-medium text-gray-800">Citizen:</p>
            <p className="text-gray-700">Mutlaqan. Wa yumkin an nustaʿmil al-naql al-ʿamm akthar min as-sayyarat.</p>
