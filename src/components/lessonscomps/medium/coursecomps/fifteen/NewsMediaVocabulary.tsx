      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        <div className="border border-red-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between items-center">
            <p className="font-bold text-lg text-gray-900">Al-akhbar</p>
            <span className="text-2xl">📰</span>
          </div>
          <p className="text-gray-600">News</p>
          <p className="text-sm text-gray-500 mt-1">الأخبار</p>
          <p className="text-xs text-red-600 mt-2">Current events</p>
        </div>
        
        <div className="border border-red-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between items-center">
            <p className="font-bold text-lg text-gray-900">As-sahafa</p>
            <span className="text-2xl">📄</span>
          </div>
        ...
        <div className="border border-red-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between items-center">
            <p className="font-bold text-lg text-gray-900">Al-idha'a</p>
            <span className="text-2xl">📻</span>
          </div>
          <p className="text-gray-600">Radio</p>
          <p className="text-sm text-gray-500 mt-1">الإذاعة</p>
          <p className="text-xs text-red-600 mt-2">Broadcasting</p>
        </div>
        
        <div className="border border-red-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between items-center">
            <p className="font-bold text-lg text-gray-900">At-tilifizyun</p>
            <span className="text-2xl">📺</span>
          </div>
