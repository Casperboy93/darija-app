      ...
      <div className="space-y-6">
        <div className="bg-orange-50 border border-orange-200 p-6 rounded-lg">
          <h3 className="text-lg font-semibold mb-3 text-orange-800 flex items-center">
            ...
            Historical Sites (Al-mawāqiʿ at-tārīkhiyya)
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Qaṣr</p>
            ...
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Jāmiʿ</p>
            ...
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Madīna qadīma</p>
        ...
        <div className="bg-orange-50 border border-orange-200 p-6 rounded-lg">
          <h3 className="text-lg font-semibold mb-3 text-orange-800 flex items-center">
            ...
            Cultural Activities (Al-anshiṭa ath-thaqāfiyya)
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Sūq</p>
            ...
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Ḥirfa</p>
            ...
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Mūsīqā</p>
            ...
            <div className="bg-white p-4 rounded-md border border-orange-100">
              <p className="font-bold text-gray-900">Raqṣ</p>
