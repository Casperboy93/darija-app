      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
        <div className="border border-green-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "Qitar ghadi yousel f sa3a thmanya" (The train will arrive at 8 o'clock)</p>
          </div>
        </div>
        ...
        <div className="border border-green-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "Tayyara ghadi ttir men Casablanca" (The plane will fly from Casablanca)</p>
          </div>
        </div>

        <div className="border border-green-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between">
            <p className="font-bold text-lg text-gray-900">Kar kra</p>
            <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Transport</span>
          </div>
          <p className="text-gray-600">Rental car</p>
          <p className="text-sm italic mt-2 text-gray-500">Pronounced: kar kra</p>
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "Bghit nkri kar li usbu3" (I want to rent a car for a week)</p>
          </div>
        </div>

        <div className="border border-green-200 rounded-lg p-5 bg-white hover:shadow-md transition-shadow">
          <div className="flex justify-between">
            <p className="font-bold text-lg text-gray-900">Babur</p>
            <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Transport</span>
          </div>
          <p className="text-gray-600">Ship/Boat</p>
          <p className="text-sm italic mt-2 text-gray-500">Pronounced: ba-bur</p>
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-sm text-gray-600">Example: "Babur ghadi yousel l Tanger" (The ship will arrive in Tangier)</p>
          </div>
        </div>
      </div>
    </div>
